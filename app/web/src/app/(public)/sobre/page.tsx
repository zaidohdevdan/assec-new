    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch mb-16">
        <div className="flex flex-col justify-center">
          ...
          <p className="text-text-secondary mb-4 leading-relaxed">
            Fundada com o intuito de ser a voz ativa dos profissionais de segurança, a ASSEC consolidou-se como uma das entidades mais respeitadas do estado. Através de representação jurídica robusta, assistência social constante e parcerias estratégicas, garantimos que nossa categoria tenha o respaldo necessário para desempenhar seu papel fundamental na sociedade.
          </p>
          <p className="text-text-secondary leading-relaxed">
            Nossos diretores e colaboradores partilham da mesma determinação: lutar por dignidade profissional, remunerações justas e a preservação dos direitos conquistados ao longo de décadas.
          </p>
        </div>
      ...
      <div className="border-t border-border pt-16">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="bg-primary text-white border border-primary-light rounded-lg shadow-lg px-8 py-5 text-center max-w-md w-full transition-all hover:scale-[1.02] hover:shadow-xl duration-300 relative group overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
            <Users className="h-6 w-6 text-accent mx-auto mb-2" />
            <span className="text-[9px] uppercase font-bold tracking-widest text-accent-light block">Órgão Deliberativo Máximo</span>
            <h3 className="font-serif font-bold text-lg mt-1">Assembleia Geral</h3>
            <p className="text-[10px] text-gray-300 mt-1">Composta por todos os associados em pleno gozo de seus direitos</p>
          </div>
          <div className="w-0.5 h-8 bg-gradient-to-b from-primary to-slate-300"></div>
        </div>

        {/* Level 2: Conselho Fiscal & Assessoria Jurídica */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          {/* Conselho Fiscal */}
          <div className="bg-slate-900 text-white border border-slate-800 rounded-lg shadow-md p-6 transition-all hover:border-accent/40 duration-300">
            <div className="flex items-center gap-3 mb-4 border-b border-slate-800 pb-3">
              <ClipboardCheck className="h-5 w-5 text-accent" />
              <div>
                <span className="text-[9px] uppercase font-bold tracking-widest text-accent-light block">Órgão Fiscalizador</span>
                <h3 className="font-serif font-bold text-base text-white">Conselho Fiscal</h3>
              </div>
            </div>
            <div className="space-y-3">
              <div className="bg-slate-950/60 p-3 rounded border border-slate-800/80">
                <span className="text-[9px] uppercase font-bold text-gray-400 block">Presidente</span>
                <span className="font-sans font-bold text-sm text-accent-light block">João Paulo Gomes do Amaral</span>
                <span className="text-[9px] text-gray-500 block">Policial Militar</span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-slate-950/60 p-3 rounded border border-slate-800/80">
                  <span className="text-[9px] uppercase font-bold text-gray-400 block">Membro Titular (Relator)</span>
                  <span className="font-sans font-semibold text-xs text-white block">Daniel Ferreira de Almeida</span>
                  <span className="text-[9px] text-gray-500 block">Policial Penal</span>
                </div>
                <div className="bg-slate-950/60 p-3 rounded border border-slate-800/80">
                  <span className="text-[9px] uppercase font-bold text-gray-400 block">Membro Titular (Secretário)</span>
                  <span className="font-sans font-semibold text-xs text-white block">Francisco Eugênio Freitas de Carvalho</span>
                  <span className="text-[9px] text-gray-500 block">Policial Penal</span>
                </div>
              </div>
            </div>
          ...
          {/* Assessoria Jurídica */}
          <div className="bg-slate-900 text-white border border-slate-800 rounded-lg shadow-md p-6 transition-all hover:border-accent/40 duration-300 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-4 border-b border-slate-800 pb-3">
                <Scale className="h-5 w-5 text-accent" />
                <div>
                  <span className="text-[9px] uppercase font-bold tracking-widest text-accent-light block">Suporte Técnico-Legal</span>
                  <h3 className="font-serif font-bold text-base text-white">Assessoria Jurídica</h3>
                </div>
              </div>
              <div className="bg-slate-950/60 p-4 rounded border border-slate-800/80 mb-4">
                <span className="text-[9px] uppercase font-bold text-gray-400 block">Advogado Titular</span>
                <span className="font-serif font-bold text-base text-accent-light block">Dr. Marcílio Lélis Prata</span>
                <span className="text-[10px] text-gray-400 block mt-1">OAB/CE Nº 24.530</span>
              </div>
            </div>
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="bg-primary text-white border border-primary-light rounded-full px-8 py-2.5 text-center text-xs font-bold uppercase tracking-widest shadow-md flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-8">
          <Card className="border-l-4 border-l-accent-dark p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="flex justify-between items-start mb-2">
              <span className="text-[9px] uppercase font-bold tracking-wider text-accent-dark">Diretora Presidente</span>
              <span className="text-[9px] bg-primary/10 text-primary px-2 py-0.5 rounded font-semibold">Policial Penal</span>
            </div>
          ...
          <Card className="border-l-4 border-l-accent-dark p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="flex justify-between items-start mb-2">
              <span className="text-[9px] uppercase font-bold tracking-wider text-accent-dark">Diretor Vice-Presidente</span>
              <span className="text-[9px] bg-primary/10 text-primary px-2 py-0.5 rounded font-semibold">Policial Militar</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          <Card className="border-l-4 border-l-slate-400 p-5 shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="flex justify-between items-start mb-1">
              <span className="text-[9px] uppercase font-bold tracking-wider text-text-muted">Diretor Secretário Geral</span>
              <span className="text-[9px] bg-slate-100 text-text-secondary px-2 py-0.5 rounded">Policial Militar</span>
            </div>
          ...
          <Card className="border-l-4 border-l-slate-400 p-5 shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="flex justify-between items-start mb-1">
              <span className="text-[9px] uppercase font-bold tracking-wider text-text-muted">Diretor Financeiro</span>
              <span className="text-[9px] bg-slate-100 text-text-secondary px-2 py-0.5 rounded">Policial Militar</span>
            </div>
        ...
        <div className="text-center mb-8">
          ...
          <span className="text-xs font-bold uppercase tracking-widest text-text-muted block">Diretorias Setoriais Executivas</span>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto mb-16">
          <Card className="p-4 flex flex-col justify-between items-center text-center shadow-sm hover:border-accent hover:shadow-md transition-all duration-300">
            <div>
              <span className="text-[8px] uppercase font-bold tracking-widest text-text-muted block mb-1">Administrativo</span>
              <h5 className="font-serif font-bold text-sm text-primary">Cristiano Batista Freire</h5>
              <span className="text-[8px] bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded inline-block mt-1 font-semibold">Policial Penal</span>
            </div>
          ...
          <Card className="p-4 flex flex-col justify-between items-center text-center shadow-sm hover:border-accent hover:shadow-md transition-all duration-300">
            <div>
              <span className="text-[8px] uppercase font-bold tracking-widest text-text-muted block mb-1">Esportes e Saúde</span>
          ...
          <Card className="p-4 flex flex-col justify-between items-center text-center shadow-sm hover:border-accent hover:shadow-md transition-all duration-300">
            <div>
              <span className="text-[8px] uppercase font-bold tracking-widest text-text-muted block mb-1">Família e Ação Social</span>
              <h5 className="font-serif font-bold text-sm text-primary">Francisco Henrique M. Ramos</h5>
              <span className="text-[8px] bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded inline-block mt-1 font-semibold">Policial Militar</span>
            </div>
            <p className="text-[10px] text-text-secondary mt-3 leading-relaxed">
          ...
          <Card className="p-4 flex flex-col justify-between items-center text-center shadow-sm hover:border-accent hover:shadow-md transition-all duration-300">
            <div>
              <span className="text-[8px] uppercase font-bold tracking-widest text-text-muted block mb-1">Interior</span>
          ...
          <Card className="p-4 flex flex-col justify-between items-center text-center shadow-sm hover:border-accent hover:shadow-md transition-all duration-300">
            <div>
              <span className="text-[8px] uppercase font-bold tracking-widest text-text-muted block mb-1">Metropolitano</span>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-8 max-w-4xl mx-auto shadow-inner">
          <div className="flex items-center gap-2 mb-6 border-b border-slate-200 pb-3 justify-center">
            <Users2 className="h-5 w-5 text-text-muted" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="bg-white p-3 rounded shadow-sm border border-slate-100 flex justify-between items-center">
                  <div>
                    <span className="font-sans font-semibold text-xs text-primary block">Sandra Timóteo Figueiredo</span>
                    <span className="text-[9px] text-text-muted">Policial Penal</span>
                  </div>
                  <span className="text-[8px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded">Suplente Geral</span>
                </li>
                <li className="bg-white p-3 rounded shadow-sm border border-slate-100 flex justify-between items-center">
                  <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="bg-white p-2.5 rounded shadow-sm border border-slate-100 flex justify-between items-center">
                  <div>
                    <span className="font-sans font-semibold text-xs text-primary block">Francisco Carlos Alencar Araripe</span>
                    <span className="text-[9px] text-text-muted">Empresário</span>
                  </div>
                  <span className="text-[8px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded">Suplente 1º</span>
                </li>
                <li className="bg-white p-2.5 rounded shadow-sm border border-slate-100 flex justify-between items-center">
                  <div>
                  ...
                  <span className="text-[8px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded">Suplente 2º</span>
                </li>
                <li className="bg-white p-2.5 rounded shadow-sm border border-slate-100 flex justify-between items-center">
                  <div>
                    <span className="font-sans font-semibold text-xs text-primary block">Reuwerth Raimny Brasil</span>
                    <span className="text-[9px] text-text-muted">Policial Militar</span>
                  </div>
                  <span className="text-[8px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded">Suplente 3º</span>
                </li>
              </ul>
            </div>
          </div>
